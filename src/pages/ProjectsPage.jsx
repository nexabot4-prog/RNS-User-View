            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-4 relative">
                    ...
                    <button
                        ...
                        className="absolute right-0 top-0 p-2 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-lg transition-colors border border-white/5 hidden md:block"
                ...
                {/* Search and Filter */}
                <div className="flex flex-col md:flex-row gap-6 items-center justify-between sticky top-20 z-30 bg-black/80 backdrop-blur-md p-4 rounded-2xl border border-white/5">
                    {/* Search Bar */}
                    ...
                    <button
                        onClick={handleRefresh}
                        className="md:hidden p-2 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-lg transition-colors border border-white/5 self-end"
                    >
                        <div className={isRefreshing ? "animate-spin" : ""}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" /><path d="M3 3v5h5" /><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16" /><path d="M16 16h5v5" /></svg>
                        </div>
                        ...
                        <AnimatePresence>
                            {isDropdownOpen && (
                                <motion.div
                                    ...
                                    className="absolute top-full left-0 right-0 mt-2 bg-[#1A1A1A] border border-white/10 rounded-xl shadow-2xl overflow-hidden py-2"
                                >
                            ...
                            {filteredProjects.length > 0 ? (
                                filteredProjects.map((project, index) => (
                                    <motion.div
                                        ...
                                        className="bg-[#121212] border border-white/5 rounded-2xl overflow-hidden hover:border-primary/30 transition-all group flex flex-col h-full"
                                    >
                                        <div className="relative h-48 overflow-hidden">
                                            ...
                                            <div className="absolute top-4 right-4 z-20">
                                                <span className="bg-black/60 backdrop-blur-md border border-white/10 text-white text-xs px-3 py-1 rounded-full uppercase tracking-wider">
                                        ...
                                        <div className="p-6 flex flex-col flex-1 space-y-4">
                                            <div className="flex-1 space-y-2">
                                                <h3
                                                    ...
                                                    className="text-xl font-bold text-white group-hover:text-cyan-400 hover:text-cyan-300 transition-colors duration-300 line-clamp-1 cursor-pointer"
                                                >
                                                    {project.title}
                                                </h3>
                                            ...
                                            <div className="grid grid-cols-2 gap-3 pt-2">
                                                <button
                                                    ...
                                                    className="bg-white text-black font-bold py-2.5 rounded-xl hover:bg-gray-200 transition-colors text-sm"
                                                >
                                                    Buy Now
                                                </button>
                                                <button
