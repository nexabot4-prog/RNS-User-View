                        ...
                        <div className="flex-1 overflow-y-auto p-6 md:p-10 custom-scrollbar">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                                ...
                                <DetailSection title="Timeline" icon={Calendar} className="col-span-1">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between border-b border-dashed border-gray-200 dark:border-gray-700 pb-2">
                                            <span className="text-gray-500 text-sm">Est. End Date</span>
                                            <span className="font-medium">{formatDate(project.end_date)}</span>
                                        </div>
                                        {project.actual_end_date && (
                                            <div className="flex justify-between border-b border-dashed border-gray-200 dark:border-gray-700 pb-2">
                                                <span className="text-gray-500 text-sm">Completion Date</span>
                                                <span className="font-medium text-primary">{formatDate(project.actual_end_date)}</span>
                                            </div>
                                        )}
                                    </div>
                                </DetailSection>
                            ...
                            <div className="mt-10 flex justify-end gap-4">
                                ...
                                <button
                                    onClick={() => {
                                        onClose();
                                        // Optional: Trigger "Add to Cart" or other action if needed
                                    }}
