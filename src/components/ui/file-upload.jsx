  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden bg-neutral-900 border border-neutral-800">
        <input
          ref={fileInputRef}
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-[0px_10px_50px_rgba(0,0,0,0.1)] border border-neutral-800"
                )}>
                {isDragActive ? (
                  <motion.p
                    initial={{ opacity: 0 }}
