            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        ...
                        {/* Input Area */}
                        <div className="p-4 bg-white/10 dark:bg-black/20 backdrop-blur-md border-t border-white/10">
                            <form onSubmit={handleSendMessage} className="relative flex items-center gap-2">
                                <input
                                    ...
                                    className="w-full bg-white/20 dark:bg-white/5 border border-white/20 text-gray-900 dark:text-white placeholder-gray-600 dark:placeholder-gray-400 rounded-xl py-3 pl-4 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-transparent transition-all shadow-inner"
                                />
                                <button
                                    type="submit"
