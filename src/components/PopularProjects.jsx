            ...
            <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 dark:border-neutral-800 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="bg-black dark:bg-white text-white dark:text-black px-4 py-2 rounded-full font-bold text-xs sm:text-sm hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors shadow-md"
                    >
                        Buy Now
                    </button>
                </div>
...
const PopularProjects = () => {
    ...
    const handleAddToCart = async (e, project) => {
        ...
        setSelectedProjectForCheckout(project)
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                                            ...
                                            {index === array.length - 1 ? (
                                                <RequestProjectCard setIsModalOpen={() => {
