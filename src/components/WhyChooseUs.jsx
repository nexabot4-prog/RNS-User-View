                        ...
                        return (
                            ...
                            >
                                <motion.div
                                    ...
                                    className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary dark:bg-white dark:text-blue-600 group-hover:bg-primary dark:group-hover:!bg-blue-600 group-hover:text-white transition-all duration-300"
                                >
